...
namespace Marechai.ApiClient.Smartphones.Companies.Letter.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Smartphones.Companies.Letter.Item.WithCItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/smartphones/companies/letter/{c}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Smartphones.Companies.Letter.Item.WithCItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/smartphones/companies/letter/{c}", rawUrl)
        {
        }
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.Smartphones.Companies.Letter.Item.WithCItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.Smartphones.Companies.Letter.Item.WithCItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
