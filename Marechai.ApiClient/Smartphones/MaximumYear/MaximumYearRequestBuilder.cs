...
namespace Marechai.ApiClient.Smartphones.MaximumYear
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Smartphones.MaximumYear.MaximumYearRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MaximumYearRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/smartphones/maximum-year", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Smartphones.MaximumYear.MaximumYearRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MaximumYearRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/smartphones/maximum-year", rawUrl)
        {
        }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marechai.ApiClient.Smartphones.MaximumYear.MaximumYearRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.Smartphones.MaximumYear.MaximumYearRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.Smartphones.MaximumYear.MaximumYearRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
