...
namespace Marechai.ApiClient.Smartphones.MinimumYear
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Smartphones.MinimumYear.MinimumYearRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MinimumYearRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/smartphones/minimum-year", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Smartphones.MinimumYear.MinimumYearRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MinimumYearRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/smartphones/minimum-year", rawUrl)
        {
        }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marechai.ApiClient.Smartphones.MinimumYear.MinimumYearRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.Smartphones.MinimumYear.MinimumYearRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.Smartphones.MinimumYear.MinimumYearRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
