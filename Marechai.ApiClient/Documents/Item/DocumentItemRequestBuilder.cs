...
using Marechai.ApiClient.Documents.Item.Companies;
...
using System;
namespace Marechai.ApiClient.Documents.Item
{
    /// <summary>
    ...
    public partial class DocumentItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Marechai.ApiClient.Documents.Item.Companies.CompaniesRequestBuilder Companies
        {
            get => new global::Marechai.ApiClient.Documents.Item.Companies.CompaniesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The machineFamilies property</summary>
        public global::Marechai.ApiClient.Documents.Item.MachineFamilies.MachineFamiliesRequestBuilder MachineFamilies
        {
            get => new global::Marechai.ApiClient.Documents.Item.MachineFamilies.MachineFamiliesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The machines property</summary>
        public global::Marechai.ApiClient.Documents.Item.Machines.MachinesRequestBuilder Machines
        {
            get => new global::Marechai.ApiClient.Documents.Item.Machines.MachinesRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new global::Marechai.ApiClient.Documents.Item.Synopses.SynopsesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The synopsis property</summary>
        public global::Marechai.ApiClient.Documents.Item.Synopsis.SynopsisRequestBuilder Synopsis
        {
            get => new global::Marechai.ApiClient.Documents.Item.Synopsis.SynopsisRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Documents.Item.DocumentItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Marechai.ApiClient.Models.DocumentDto?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marechai.ApiClient.Models.DocumentDto> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Marechai.ApiClient.Models.DocumentDto>(requestInfo, global::Marechai.ApiClient.Models.DocumentDto.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <returns>A <see cref="string"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<string?> PutAsync(global::Marechai.ApiClient.Models.DocumentDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<string> PutAsync(global::Marechai.ApiClient.Models.DocumentDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::Marechai.ApiClient.Models.DocumentDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::Marechai.ApiClient.Models.DocumentDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.Documents.Item.DocumentItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.Documents.Item.DocumentItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
