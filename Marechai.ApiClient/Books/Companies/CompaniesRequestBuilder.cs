...
using Marechai.ApiClient.Books.Companies.Item;
using Marechai.ApiClient.Books.Companies.Letter;
...
using System;
namespace Marechai.ApiClient.Books.Companies
{
    /// <summary>
    ...
    public partial class CompaniesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Marechai.ApiClient.Books.Companies.Letter.LetterRequestBuilder Letter
        {
            get => new global::Marechai.ApiClient.Books.Companies.Letter.LetterRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Gets an item from the Marechai.ApiClient.books.companies.item collection</summary>
        /// <param name="position">Unique identifier of the item</param>
        /// <returns>A <see cref="global::Marechai.ApiClient.Books.Companies.Item.CompaniesItemRequestBuilder"/></returns>
        public global::Marechai.ApiClient.Books.Companies.Item.CompaniesItemRequestBuilder this[long position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("id", position);
                return new global::Marechai.ApiClient.Books.Companies.Item.CompaniesItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the Marechai.ApiClient.books.companies.item collection</summary>
        /// <param name="position">Unique identifier of the item</param>
        ...
        public global::Marechai.ApiClient.Books.Companies.Item.CompaniesItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Books.Companies.CompaniesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<long?> PostAsync(global::Marechai.ApiClient.Models.CompanyByBookDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<long?> PostAsync(global::Marechai.ApiClient.Models.CompanyByBookDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Marechai.ApiClient.Models.CompanyByBookDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Marechai.ApiClient.Models.CompanyByBookDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marechai.ApiClient.Books.Companies.CompaniesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.Books.Companies.CompaniesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.Books.Companies.CompaniesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
