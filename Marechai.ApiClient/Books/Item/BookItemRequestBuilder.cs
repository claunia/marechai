...
using System;
namespace Marechai.ApiClient.Books.Item
{
    /// <summary>
    ...
    public partial class BookItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Marechai.ApiClient.Books.Item.Companies.CompaniesRequestBuilder Companies
        {
            get => new global::Marechai.ApiClient.Books.Item.Companies.CompaniesRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new global::Marechai.ApiClient.Books.Item.MachineFamilies.MachineFamiliesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The machines property</summary>
        public global::Marechai.ApiClient.Books.Item.Machines.MachinesRequestBuilder Machines
        {
            get => new global::Marechai.ApiClient.Books.Item.Machines.MachinesRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new global::Marechai.ApiClient.Books.Item.Synopses.SynopsesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The synopsis property</summary>
        public global::Marechai.ApiClient.Books.Item.Synopsis.SynopsisRequestBuilder Synopsis
        {
            get => new global::Marechai.ApiClient.Books.Item.Synopsis.SynopsisRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Books.Item.BookItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Marechai.ApiClient.Models.BookDto?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marechai.ApiClient.Models.BookDto> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Marechai.ApiClient.Models.BookDto>(requestInfo, global::Marechai.ApiClient.Models.BookDto.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <returns>A <see cref="Stream"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> PutAsync(global::Marechai.ApiClient.Models.BookDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> PutAsync(global::Marechai.ApiClient.Models.BookDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::Marechai.ApiClient.Models.BookDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::Marechai.ApiClient.Models.BookDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.Books.Item.BookItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.Books.Item.BookItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
