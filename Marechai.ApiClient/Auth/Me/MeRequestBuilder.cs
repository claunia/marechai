...
using System;
namespace Marechai.ApiClient.Auth.Me
{
    /// <summary>
    ...
    public partial class MeRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Marechai.ApiClient.Auth.Me.Avatar.AvatarRequestBuilder Avatar
        {
            get => new global::Marechai.ApiClient.Auth.Me.Avatar.AvatarRequestBuilder(PathParameters, RequestAdapter);
        }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Marechai.ApiClient.Models.UserDto?> PutAsync(global::Marechai.ApiClient.Models.UpdateProfileRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Marechai.ApiClient.Models.UserDto> PutAsync(global::Marechai.ApiClient.Models.UpdateProfileRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::Marechai.ApiClient.Models.UpdateProfileRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::Marechai.ApiClient.Models.UpdateProfileRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marechai.ApiClient.Auth.Me.MeRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.Auth.Me.MeRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.Auth.Me.MeRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
