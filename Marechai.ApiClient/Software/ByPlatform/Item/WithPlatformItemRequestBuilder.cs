...
using Marechai.ApiClient.Software.ByPlatform.Item.Count;
...
using System;
namespace Marechai.ApiClient.Software.ByPlatform.Item
{
    /// <summary>
    ...
    public partial class WithPlatformItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Marechai.ApiClient.Software.ByPlatform.Item.Count.CountRequestBuilder Count
        {
            get => new global::Marechai.ApiClient.Software.ByPlatform.Item.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Software.ByPlatform.Item.WithPlatformItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithPlatformItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/software/by-platform/{platformId}{?kind*,skip*,take*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Software.ByPlatform.Item.WithPlatformItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithPlatformItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/software/by-platform/{platformId}{?kind*,skip*,take*}", rawUrl)
        {
        }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marechai.ApiClient.Software.ByPlatform.Item.WithPlatformItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.Software.ByPlatform.Item.WithPlatformItemRequestBuilder WithUrl(string rawUrl)
        {
