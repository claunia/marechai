...
using System;
namespace Marechai.ApiClient.Software.Variants.Companies.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \software\variants\companies\{id}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class CompaniesItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Software.Variants.Companies.Item.CompaniesItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CompaniesItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/software/variants/companies/{id}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Software.Variants.Companies.Item.CompaniesItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CompaniesItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/software/variants/companies/{id}", rawUrl)
        {
        }
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.Software.Variants.Companies.Item.CompaniesItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.Software.Variants.Companies.Item.CompaniesItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
