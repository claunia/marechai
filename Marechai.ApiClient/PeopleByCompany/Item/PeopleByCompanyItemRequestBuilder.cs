...
using System;
namespace Marechai.ApiClient.PeopleByCompany.Item
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.PeopleByCompany.Item.PeopleByCompanyItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> PutAsync(global::Marechai.ApiClient.Models.PersonByCompanyDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> PutAsync(global::Marechai.ApiClient.Models.PersonByCompanyDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::Marechai.ApiClient.Models.PersonByCompanyDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::Marechai.ApiClient.Models.PersonByCompanyDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.PeopleByCompany.Item.PeopleByCompanyItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.PeopleByCompany.Item.PeopleByCompanyItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
