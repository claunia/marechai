...
using System;
namespace Marechai.ApiClient.InvitationCodes.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \invitation-codes\{code}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithCodeItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.InvitationCodes.Item.WithCodeItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCodeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/invitation-codes/{code}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.InvitationCodes.Item.WithCodeItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCodeItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/invitation-codes/{code}", rawUrl)
        {
        }
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.InvitationCodes.Item.WithCodeItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.InvitationCodes.Item.WithCodeItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
