...
using System;
namespace Marechai.ApiClient.Processors.Item.Machines
{
    /// <summary>
    /// Builds and executes requests for operations under \processors\{-id}\machines
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class MachinesRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Processors.Item.Machines.MachinesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MachinesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/processors/{%2Did}/machines", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Processors.Item.Machines.MachinesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MachinesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/processors/{%2Did}/machines", rawUrl)
        {
        }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marechai.ApiClient.Processors.Item.Machines.MachinesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.Processors.Item.Machines.MachinesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.Processors.Item.Machines.MachinesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
