...
using Marechai.ApiClient.Processors.Count;
...
using System;
namespace Marechai.ApiClient.Processors
{
    /// <summary>
    ...
    public partial class ProcessorsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Marechai.ApiClient.Processors.Count.CountRequestBuilder Count
        {
            get => new global::Marechai.ApiClient.Processors.Count.CountRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Processors.ProcessorsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::Marechai.ApiClient.Models.ProcessorDto>?> GetAsync(Action<RequestConfiguration<global::Marechai.ApiClient.Processors.ProcessorsRequestBuilder.ProcessorsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Marechai.ApiClient.Models.ProcessorDto>> GetAsync(Action<RequestConfiguration<global::Marechai.ApiClient.Processors.ProcessorsRequestBuilder.ProcessorsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<long?> PostAsync(global::Marechai.ApiClient.Models.ProcessorDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<long?> PostAsync(global::Marechai.ApiClient.Models.ProcessorDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marechai.ApiClient.Processors.ProcessorsRequestBuilder.ProcessorsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marechai.ApiClient.Processors.ProcessorsRequestBuilder.ProcessorsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Marechai.ApiClient.Models.ProcessorDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Marechai.ApiClient.Models.ProcessorDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marechai.ApiClient.Processors.ProcessorsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.Processors.ProcessorsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.Processors.ProcessorsRequestBuilder(rawUrl, RequestAdapter);
        }
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ProcessorsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Marechai.ApiClient.Processors.ProcessorsRequestBuilder.ProcessorsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
