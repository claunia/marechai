...
using System;
namespace Marechai.ApiClient.Users.Item.Password
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Users.Item.Password.PasswordRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(global::Marechai.ApiClient.Models.ChangePasswordRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(global::Marechai.ApiClient.Models.ChangePasswordRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Marechai.ApiClient.Models.ChangePasswordRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Marechai.ApiClient.Models.ChangePasswordRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Marechai.ApiClient.Users.Item.Password.PasswordRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Marechai.ApiClient.Users.Item.Password.PasswordRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Marechai.ApiClient.Users.Item.Password.PasswordRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
