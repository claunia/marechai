...
namespace Marechai.ApiClient.Computers
{
    ...
    public partial class ComputersRequestBuilder : BaseRequestBuilder
    {
        ...
        public ComputersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/computers{?skip*,take*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Computers.ComputersRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ComputersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/computers{?skip*,take*}", rawUrl)
        {
        }
...
#nullable enable
        public async Task<List<global::Marechai.ApiClient.Models.MachineDto>?> GetAsync(Action<RequestConfiguration<global::Marechai.ApiClient.Computers.ComputersRequestBuilder.ComputersRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Marechai.ApiClient.Models.MachineDto>> GetAsync(Action<RequestConfiguration<global::Marechai.ApiClient.Computers.ComputersRequestBuilder.ComputersRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marechai.ApiClient.Computers.ComputersRequestBuilder.ComputersRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Marechai.ApiClient.Computers.ComputersRequestBuilder.ComputersRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ComputersRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Marechai.ApiClient.Computers.ComputersRequestBuilder.ComputersRequestBuilderGetQueryParameters>
        {
        }
    }
}
