...
namespace Marechai.ApiClient.Computers.Prototypes
{
    ...
    public partial class PrototypesRequestBuilder : BaseRequestBuilder
    {
        ...
        public PrototypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/computers/prototypes", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Marechai.ApiClient.Computers.Prototypes.PrototypesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PrototypesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/computers/prototypes", rawUrl)
        {
        }
