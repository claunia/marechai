...
namespace Cicm.Database.Migrations
{
    ...
    class cicmContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Cicm.Database.Models.Document", b =>
            {
                b.Property<long>("Id").ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Cicm.Database.Models.MagazinesByMachine", b =>
            {
                b.Property<long>("Id").ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Cicm.Database.Models.PeopleByBook", b =>
            {
                b.Property<long>("Id").ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Cicm.Database.Models.CompaniesByBook", b =>
            {
                ...
                b.HasOne("Cicm.Database.Models.DocumentCompany", "Company").WithMany("Books").HasForeignKey("CompanyId")
                 .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Cicm.Database.Models.CompanyLogo",
                                b =>
                                {
                                    b.HasOne("Cicm.Database.Models.Company", "Company").WithMany("Logos")
                                     .HasForeignKey("CompanyId").HasConstraintName("fk_company_logos_company1");
                                });

            modelBuilder.Entity("Cicm.Database.Models.Document",
                                b =>
                                {
            ...
            modelBuilder.Entity("Cicm.Database.Models.MagazinesByMachine", b =>
            {
                b.HasOne("Cicm.Database.Models.Machine", "Machine").WithMany("Magazines").HasForeignKey("MachineId")
                 .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Cicm.Database.Models.PeopleByBook", b =>
            {
                b.HasOne("Cicm.Database.Models.Book", "Book").WithMany("People").HasForeignKey("BookId")
                 .OnDelete(DeleteBehavior.Cascade);

                b.HasOne("Cicm.Database.Models.DocumentPerson", "Person").WithMany("Books").HasForeignKey("PersonId")
                 .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Cicm.Database.Models.PeopleByCompany", b =>
            {
                b.HasOne("Cicm.Database.Models.Company", "Company").WithMany("People").HasForeignKey("CompanyId")
                 .OnDelete(DeleteBehavior.Cascade);
