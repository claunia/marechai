    ...
    class cicmContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Marechai.Database.Models.License", b =>
            {
                ...
                b.HasData(new {Id = 1, FsfApproved = false, Name = "Fair use", OsiApproved            = false},
                          new {Id = 2, FsfApproved = false, Name = "Advertisement use", OsiApproved   = false},
                          new {Id = 3, FsfApproved = false, Name = "All rights reserved", OsiApproved = false},
                          new
                          {
                              Id          = 4,
                              FsfApproved = false,
            ...
            modelBuilder.Entity("Marechai.Database.Models.CompaniesByBook", b =>
            {
                ...
                b.HasOne("Marechai.Database.Models.DocumentCompany", "Company").WithMany("Books").HasForeignKey("CompanyId")
                 .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Marechai.Database.Models.CompaniesByDocument", b =>
            {
                ...
                b.HasOne("Marechai.Database.Models.Document", "Document").WithMany("Companies").HasForeignKey("DocumentId")
                 .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Marechai.Database.Models.CompaniesByMagazine", b =>
            {
                ...
                b.HasOne("Marechai.Database.Models.Magazine", "Magazine").WithMany("Companies").HasForeignKey("MagazineId")
                 .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Marechai.Database.Models.CompanyDescription",
                                b =>
                                {
            ...
            modelBuilder.Entity("Marechai.Database.Models.CompanyLogo",
                                b =>
                                {
                                    b.HasOne("Marechai.Database.Models.Company", "Company").WithMany("Logos")
                                     .HasForeignKey("CompanyId").HasConstraintName("fk_company_logos_company1");
                                });

            modelBuilder.Entity("Marechai.Database.Models.Document",
                                b =>
                                {
            ...
            modelBuilder.Entity("Marechai.Database.Models.DocumentCompany",
                                b =>
                                {
            ...
            modelBuilder.Entity("Marechai.Database.Models.DocumentPerson",
                                b =>
                                {
            ...
            modelBuilder.Entity("Marechai.Database.Models.DocumentsByMachine", b =>
            {
                b.HasOne("Marechai.Database.Models.Document", "Document").WithMany("Machines").HasForeignKey("DocumentId")
                 .OnDelete(DeleteBehavior.Cascade);

                b.HasOne("Marechai.Database.Models.Machine", "Machine").WithMany("Documents").HasForeignKey("MachineId")
                 .OnDelete(DeleteBehavior.Cascade);
            });
            ...
            modelBuilder.Entity("Marechai.Database.Models.Gpu",
                                b =>
                                {
                                    b.HasOne("Marechai.Database.Models.Company", "Company").WithMany("Gpus")
            ...
            modelBuilder.Entity("Marechai.Database.Models.Machine", b =>
            {
                ...
                b.HasOne("Marechai.Database.Models.MachineFamily", "Family").WithMany("Machines").HasForeignKey("FamilyId")
            ...
            modelBuilder.Entity("Marechai.Database.Models.MagazineIssue",
                                b =>
                                {
            ...
            modelBuilder.Entity("Marechai.Database.Models.MagazinesByMachine", b =>
            {
                b.HasOne("Marechai.Database.Models.Machine", "Machine").WithMany("Magazines").HasForeignKey("MachineId")
                 .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Marechai.Database.Models.MemoryByMachine",
                                b =>
                                {
                                    b.HasOne("Marechai.Database.Models.Machine", "Machine").WithMany("Memory")
            ...
            modelBuilder.Entity("Marechai.Database.Models.PeopleByBook", b =>
            {
                ...
                b.HasOne("Marechai.Database.Models.DocumentPerson", "Person").WithMany("Books").HasForeignKey("PersonId")
                 .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Marechai.Database.Models.PeopleByDocument", b =>
            {
                b.HasOne("Marechai.Database.Models.Document", "Document").WithMany("People").HasForeignKey("DocumentId")
                 .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Marechai.Database.Models.Person",
                                b =>
                                {
            ...
            modelBuilder.Entity("Marechai.Database.Models.Processor", b =>
            {
                b.HasOne("Marechai.Database.Models.Company", "Company").WithMany("Processors").HasForeignKey("CompanyId")
            ...
            modelBuilder.Entity("Marechai.Database.Models.ProcessorsByMachine", b =>
            {
                b.HasOne("Marechai.Database.Models.Machine", "Machine").WithMany("Processors").HasForeignKey("MachineId")
            ...
            modelBuilder.Entity("Marechai.Database.Models.Screen",
                                b =>
                                {
            ...
            modelBuilder.Entity("Marechai.Database.Models.SoundSynth",
                                b =>
                                {
            ...
            modelBuilder.Entity("Marechai.Database.Models.StorageByMachine",
                                b =>
                                {
                                    b.HasOne("Marechai.Database.Models.Machine", "Machine").WithMany("Storage")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>",
                                b =>
                                {
                                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityRole").WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>",
                                b =>
                                {
                                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser").WithMany()
                                     .HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade);
                                });
