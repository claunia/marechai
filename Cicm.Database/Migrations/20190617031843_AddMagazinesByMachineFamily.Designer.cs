...
namespace Cicm.Database.Migrations
{
    ...
    [Migration("20190617031843_AddMagazinesByMachineFamily")]
    partial class AddMagazinesByMachineFamily
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cicm.Database.Models.Book", b =>
                {
                    ...
                    b.HasOne("Cicm.Database.Models.Book", "Previous")
                        .WithOne("Next")
                        .HasForeignKey("Cicm.Database.Models.Book", "PreviousId");

                    b.HasOne("Cicm.Database.Models.Book", "Source")
                        .WithMany("Derivates")
            ...
            modelBuilder.Entity("Cicm.Database.Models.BooksByMachine", b =>
                {
                    b.HasOne("Cicm.Database.Models.Book", "Book")
                        .WithMany("Machines")
            ...
            modelBuilder.Entity("Cicm.Database.Models.BooksByMachineFamily", b =>
                {
                    ...
                    b.HasOne("Cicm.Database.Models.MachineFamily", "MachineFamily")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Cicm.Database.Models.CompaniesByBook", b =>
                {
                    ...
                    b.HasOne("Cicm.Database.Models.DocumentCompany", "Company")
                        .WithMany("Books")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Cicm.Database.Models.DocumentRole", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Cicm.Database.Models.CompaniesByDocument", b =>
                {
                    ...
                    b.HasOne("Cicm.Database.Models.Document", "Document")
                        .WithMany("Companies")
            ...
            modelBuilder.Entity("Cicm.Database.Models.CompaniesByMagazine", b =>
                {
                    ...
                    b.HasOne("Cicm.Database.Models.Magazine", "Magazine")
                        .WithMany("Companies")
            ...
            modelBuilder.Entity("Cicm.Database.Models.Company", b =>
                {
                    ...
                    b.HasOne("Cicm.Database.Models.DocumentCompany", "DocumentCompany")
                        .WithOne("Company")
                        .HasForeignKey("Cicm.Database.Models.Company", "DocumentCompanyId")
            ...
            modelBuilder.Entity("Cicm.Database.Models.GpusByOwnedMachine", b =>
                {
                    ...
                    b.HasOne("Cicm.Database.Models.OwnedMachine", "OwnedMachine")
                        .WithMany("Gpus")
            ...
            modelBuilder.Entity("Cicm.Database.Models.MachinePhoto", b =>
                {
                    b.HasOne("Cicm.Database.Models.License", "License")
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("Cicm.Database.Models.MagazinesByMachine", b =>
                {
                    ...
                    b.HasOne("Cicm.Database.Models.MagazineIssue", "Magazine")
                        .WithMany("Machines")
                        .HasForeignKey("MagazineId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Cicm.Database.Models.PeopleByBook", b =>
                {
                    ...
                    b.HasOne("Cicm.Database.Models.DocumentPerson", "Person")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Cicm.Database.Models.ResolutionsByScreen", b =>
                {
                    ...
                    b.HasOne("Cicm.Database.Models.Screen", "Screen")
            ...
            modelBuilder.Entity("Cicm.Database.Models.Screen", b =>
                {
                    b.HasOne("Cicm.Database.Models.Resolution", "NativeResolution")
                        .WithMany("Screens")
