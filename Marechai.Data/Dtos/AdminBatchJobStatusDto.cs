...
public class AdminBatchJobItemResultDto
{
...
/// <summary>
///     Polling response for an in-flight admin batch-commit job. The client polls
///     <c>GET /software/covers/admin/batch/{jobId}/status</c> every ~750 ms until
///     <see cref="State" /> is <see cref="BatchJobState.Completed" /> or
///     <see cref="BatchJobState.Failed" />.
/// </summary>
public class AdminBatchJobStatusDto
{
    ...
    public List<AdminBatchJobItemResultDto> Results { get; set; } = new();
}
