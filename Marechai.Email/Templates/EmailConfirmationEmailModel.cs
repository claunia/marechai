...
/// <summary>
///     Model for <c>Templates/EmailConfirmationEmail.cshtml</c>. All user-visible strings are pre-localized by
///     <see cref="Composers.EmailConfirmationEmailComposer" /> using
...
public sealed class EmailConfirmationEmailModel
{
    ...
    /// <summary>Localized "ignore if you didn't request this" footer.</summary>
