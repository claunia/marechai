...
public class DocumentsByMachineService(MarechaiContext context)
{
    public async Task<List<DocumentByMachineViewModel>> GetByDocument(long bookId) => await context.DocumentsByMachines
