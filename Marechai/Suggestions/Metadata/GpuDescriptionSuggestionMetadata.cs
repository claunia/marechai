...
/// <summary>
///     Suggestion metadata for the per-language <c>GpuDescription</c>. The suggestion's
///     <c>Subkey</c> holds the ISO-639-3 language code; the only suggestable field is the
///     markdown body itself.
/// </summary>
public sealed class GpuDescriptionSuggestionMetadata : SuggestionMetadata
{
    /// <summary>Mirror of <c>GpuDescriptionSuggestionApplier.FieldMarkdown</c>. KEEP IN SYNC.</summary>
    ...
    static GpuDescriptionSuggestionMetadata() =>
        SuggestionMetadataRegistry.Register(new GpuDescriptionSuggestionMetadata());
    ...
    public override SuggestionEntityType EntityType => SuggestionEntityType.GpuDescription;
    ...
    public override Dictionary<string, object> ExtractCurrentValues(object currentDto)
    {
        ...
        if(currentDto is GpuDescriptionDto d)
