...
/// <summary>
///     Suggestion metadata for the per-language <c>SoftwareDescription</c>. The
///     suggestion's <c>Subkey</c> holds the ISO-639-3 language code; the only suggestable
///     field is the markdown body itself.
/// </summary>
public sealed class SoftwareDescriptionSuggestionMetadata : SuggestionMetadata
{
    /// <summary>Mirror of <c>SoftwareDescriptionSuggestionApplier.FieldMarkdown</c>. KEEP IN SYNC.</summary>
    ...
    static SoftwareDescriptionSuggestionMetadata() =>
        SuggestionMetadataRegistry.Register(new SoftwareDescriptionSuggestionMetadata());
    ...
    public override SuggestionEntityType EntityType => SuggestionEntityType.SoftwareDescription;
    ...
    public override Dictionary<string, object> ExtractCurrentValues(object currentDto)
    {
        ...
        if(currentDto is SoftwareDescriptionDto d)
