...
/// <summary>
///     Suggestion metadata for the per-language <c>ProcessorDescription</c>. The suggestion's
///     <c>Subkey</c> holds the ISO-639-3 language code; the only suggestable field is the
///     markdown body itself.
/// </summary>
public sealed class ProcessorDescriptionSuggestionMetadata : SuggestionMetadata
{
    /// <summary>Mirror of <c>ProcessorDescriptionSuggestionApplier.FieldMarkdown</c>. KEEP IN SYNC.</summary>
    ...
    static ProcessorDescriptionSuggestionMetadata() =>
        SuggestionMetadataRegistry.Register(new ProcessorDescriptionSuggestionMetadata());
    ...
    public override SuggestionEntityType EntityType => SuggestionEntityType.ProcessorDescription;
    ...
    public override Dictionary<string, object> ExtractCurrentValues(object currentDto)
    {
        ...
        if(currentDto is ProcessorDescriptionDto d)
