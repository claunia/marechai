...
/// <summary>
///     Suggestion metadata for the per-language <c>CompanyDescription</c>. The suggestion's
///     <c>Subkey</c> holds the ISO-639-3 language code; the only suggestable field is the
///     markdown body itself.
/// </summary>
public sealed class CompanyDescriptionSuggestionMetadata : SuggestionMetadata
{
    /// <summary>Mirror of <c>CompanyDescriptionSuggestionApplier.FieldMarkdown</c>. KEEP IN SYNC.</summary>
    ...
    static CompanyDescriptionSuggestionMetadata() =>
        SuggestionMetadataRegistry.Register(new CompanyDescriptionSuggestionMetadata());
    ...
    public override SuggestionEntityType EntityType => SuggestionEntityType.CompanyDescription;
    ...
    public override Dictionary<string, object> ExtractCurrentValues(object currentDto)
    {
        ...
        if(currentDto is CompanyDescriptionDto d)
