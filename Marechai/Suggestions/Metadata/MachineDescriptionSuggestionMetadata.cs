...
/// <summary>
///     Suggestion metadata for the per-language <c>MachineDescription</c>. The suggestion's
///     <c>Subkey</c> holds the ISO-639-3 language code; the only suggestable field is the
///     markdown body itself.
/// </summary>
public sealed class MachineDescriptionSuggestionMetadata : SuggestionMetadata
{
    /// <summary>Mirror of <c>MachineDescriptionSuggestionApplier.FieldMarkdown</c>. KEEP IN SYNC.</summary>
    ...
    static MachineDescriptionSuggestionMetadata() =>
        SuggestionMetadataRegistry.Register(new MachineDescriptionSuggestionMetadata());
    ...
    public override SuggestionEntityType EntityType => SuggestionEntityType.MachineDescription;
    ...
    public override Dictionary<string, object> ExtractCurrentValues(object currentDto)
    {
        ...
        if(currentDto is MachineDescriptionDto d)
