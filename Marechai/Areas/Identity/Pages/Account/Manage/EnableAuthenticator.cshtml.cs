...
public class EnableAuthenticatorModel
    (UserManager<ApplicationUser> userManager, ILogger<EnableAuthenticatorModel> logger, UrlEncoder urlEncoder)
    : PageModel
{
    const    string                       AUTHENTICATOR_URI_FORMAT = "otpauth://totp/{0}:{1}?secret={2}&issuer={0}&digits=6";
    ...
    string GenerateQrCodeUri(string email, string unformattedKey) =>
        string.Format(AUTHENTICATOR_URI_FORMAT,
                      urlEncoder.Encode("Marechai"),
