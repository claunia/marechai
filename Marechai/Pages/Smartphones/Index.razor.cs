...
public partial class Index
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        _smartphones = await Service.GetSmartphonesCountAsync();
    ...
    ///     the type to <see cref="MachineType.Smartphone" />. The dialog handles submission +
    ...
    /// </summary>
    async Task OpenSuggestNewSmartphoneDialog()
    {
        var parameters = new DialogParameters<MachineSuggestionDialog>
        {
            ...
            { x => x.IsCreation,  true                                   },
            { x => x.PrefillType, (MachineType?)MachineType.Smartphone   }
        };
        ...
        await DialogService.ShowAsync<MachineSuggestionDialog>(L["Suggest new smartphone"], parameters, options);
    }
}
