...
public partial class MachinePhoto
{
    ...
    ushort Contrast
    {
        get
        {
            if(_model.Contrast is null) return 0;
    ...
    ushort ExposureMode
    {
        get
        {
            if(_model.ExposureMethod is null) return 0;
    ...
    ushort ExposureProgram
    {
        get
        {
            if(_model.ExposureProgram is null) return 0;
    ...
    ushort Flash
    {
        get
        {
            if(_model.Flash is null) return 0;
    ...
    ushort LightSource
    {
        get
        {
            if(_model.LightSource is null) return 0;
    ...
    ushort MeteringMode
    {
        get
        {
            if(_model.MeteringMode is null) return 0;
    ...
    ushort ResolutionUnit
    {
        get
        {
            if(_model.ResolutionUnit is null) return 0;
    ...
    ushort Orientation
    {
        get
        {
            if(_model.Orientation is null) return 0;
    ...
    ushort Saturation
    {
        get
        {
            if(_model.Saturation is null) return 0;
    ...
    ushort SceneCaptureType
    {
        get
        {
            if(_model.SceneCaptureType is null) return 0;
    ...
    ushort SensingMethod
    {
        get
        {
            if(_model.SensingMethod is null) return 0;
    ...
    ushort Sharpness
    {
        get
        {
            if(_model.Sharpness is null) return 0;
    ...
    ushort SubjectDistanceRange
    {
        get
        {
            if(_model.SubjectDistanceRange is null) return 0;
    ...
    ushort WhiteBalance
    {
        get
        {
            if(_model.WhiteBalance is null) return 0;
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        _editing = NavigationManager.ToBaseRelativePath(NavigationManager.Uri)
                                    .ToLowerInvariant()
    ...
    {
        if(e.Value is ushort item && item > 0)
            e.Status = ValidationStatus.Success;
        else
            e.Status = ValidationStatus.Error;
    }
