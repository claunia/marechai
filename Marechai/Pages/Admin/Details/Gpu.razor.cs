...
public partial class Gpu
{
    ...
    {
        if(_currentResolution is null) return;
    ...
    {
        if(_addingResolutionId is null || _addingResolutionId <= 0)
        {
            CancelAddResolution();
        ...
        await ResolutionsByGpuService.CreateAsync(_addingResolutionId.Value,
                                                  Id,
                                                  (await UserManager.GetUserAsync(_authState.User)).Id);
