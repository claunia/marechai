...
public partial class CreateMachinePhoto
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        if(_machine is null) NavigationManager.ToBaseRelativePath("admin/machines");
    ...
    {
        if(!_unknownSource && string.IsNullOrWhiteSpace(_sourceUrl)) return;
        ...
        try
        {
            ...
            if(exif?.Length >= 1) exif[0].ToViewModel(_model);
