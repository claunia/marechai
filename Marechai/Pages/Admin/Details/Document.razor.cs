...
public partial class Document
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        _editing = _creating ||
                   NavigationManager.ToBaseRelativePath(NavigationManager.Uri)
                                    .ToLowerInvariant()
                                    .StartsWith("admin/documents/edit/", StringComparison.InvariantCulture);
    ...
    async Task ConfirmAddCompany()
    {
        ...
        await CompaniesByDocumentService.CreateAsync(_addingCompanyId.Value,
                                                     Id,
    ...
    void ShowCompanyDeleteModal(long itemId)
    {
        ...
        _deleteText =
            string.Format(L["Are you sure you want to delete the company {0} with role {1} from this document?"],
                          _currentCompanyByDocument?.Company,
                          _currentCompanyByDocument?.Role);
    ...
    {
        if(_currentCompanyByDocument is null) return;
    ...
    async Task ConfirmAddFamily()
    {
        ...
        await DocumentsByMachineFamilyService.CreateAsync(_addingMachineFamilyId.Value,
                                                          Id,
                                                          (await UserManager.GetUserAsync(_authState.User)).Id);
    ...
    {
        if(_currentDocumentByMachineFamily is null) return;
    ...
    async Task ConfirmAddMachine()
    {
        ...
        await DocumentsByMachineService.CreateAsync(_addingMachineId.Value,
                                                    Id,
                                                    (await UserManager.GetUserAsync(_authState.User)).Id);
    ...
    {
        if(_currentDocumentByMachine is null) return;
    ...
    async Task ConfirmAddPerson()
    {
        ...
        await PeopleByDocumentService.CreateAsync(_addingPersonId.Value,
                                                  Id,
                                                  _addingPersonRoleId,
                                                  (await UserManager.GetUserAsync(_authState.User)).Id);
    ...
    void ShowPersonDeleteModal(long itemId)
    {
        ...
        _deleteText =
            string.Format(L["Are you sure you want to delete the person {0} with role {1} from this document?"],
                          _currentPersonByDocument?.FullName,
                          _currentPersonByDocument?.Role);
    ...
    {
        if(_currentPersonByDocument is null) return;
...
#pragma warning restore 4014
    ...
    async Task OnFinishedAll(bool result)
    {
        try
        {
            await DocumentScansService.CreateAsync(_selectedScan, (await UserManager.GetUserAsync(_authState.User)).Id);
    ...
    async Task ShowScanDeleteModal(Guid scanId)
    {
        ...
        _deleteText = _selectedScan.Page.HasValue
                          ? string.Format(L["Are you sure you want to delete the scan type {0} for page {1} from this document?"],
                                          _selectedScan.Type,
                                          _selectedScan.Page)
                          : string.Format(L["Are you sure you want to delete the scan type {0} from this document?"],
                                          _selectedScan.Type);
    ...
    async Task ConfirmDeleteScan()
    {
        ...
        // TODO: Delete files
        await DocumentScansService.DeleteAsync(_selectedScan.Id, (await UserManager.GetUserAsync(_authState.User)).Id);
