...
namespace Marechai.Pages.Admin.Details
{
    public partial class Book
    {
        ...
        async Task UploadFile()
        {
            ...
            string originalFilePath = Path.Combine(Host.WebRootPath, "assets", "scans", "books", "originals",
        ...
        async Task ShowScanDeleteModal(Guid scanId)
        {
            ...
            _deleteText = _selectedScan.Page.HasValue
                              ? string.
                                  Format(L["Are you sure you want to delete the scan type {0} for page {1} from this book?"],
