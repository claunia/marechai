...
public enum InstructionSetMatchType
{
    Exact,
    Partial,
    None
...
public sealed class ProcessorImportRow
{
    ...
    public string InstructionSetDisplay
    {
        get
        {
            if(InstructionSetMatch is InstructionSetMatchType.Exact or InstructionSetMatchType.Partial &&
               SelectedInstructionSet is not null)
                return SelectedInstructionSet.Name ?? InstructionSetInput ?? "";

            return InstructionSetInput ?? "";
        }
    }
}
