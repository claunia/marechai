...
public partial class Index
{
    ...
    ///     the type to <see cref="MachineType.Computer" />. The dialog handles submission +
    ...
    /// </summary>
    async Task OpenSuggestNewComputerDialog()
    {
        var parameters = new DialogParameters<MachineSuggestionDialog>
        {
            ...
            { x => x.IsCreation,  true                                   },
            { x => x.PrefillType, (MachineType?)MachineType.Computer     }
        };
        ...
        await DialogService.ShowAsync<MachineSuggestionDialog>(L["Suggest new computer"], parameters, options);
    }
}