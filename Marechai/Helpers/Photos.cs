...
public class Photos
{
                                 ...
                                 string item)
    {
        List<Task> pool =
        [
            new Task(() => FinishedRenderingJpeg4kThumbnail?.Invoke(Convert(webRootPath,
                                                                            id,
                                                                            originalFilePath,
                                                                            sourceFormat,
                                                                            "JPEG",
                                                                            ...
                                                                            scan,
                                                                            item))),
            new Task(() => FinishedRenderingJpeg1440Thumbnail?.Invoke(Convert(webRootPath,
                                                                              id,
                                                                              originalFilePath,
                                                                              sourceFormat,
                                                                              "JPEG",
                                                                              ...
                                                                              scan,
                                                                              item))),
            new Task(() => FinishedRenderingJpegHdThumbnail?.Invoke(Convert(webRootPath,
                                                                            id,
                                                                            originalFilePath,
                                                                            sourceFormat,
                                                                            "JPEG",
                                                                            ...
                                                                            scan,
                                                                            item))),
            new Task(() => FinishedRenderingJpeg4K?.Invoke(Convert(webRootPath,
                                                                   id,
                                                                   originalFilePath,
                                                                   sourceFormat,
                                                                   "JPEG",
                                                                   ...
                                                                   scan,
                                                                   item))),
            new Task(() => FinishedRenderingJpeg1440?.Invoke(Convert(webRootPath,
                                                                     id,
                                                                     originalFilePath,
                                                                     sourceFormat,
                                                                     "JPEG",
                                                                     ...
                                                                     scan,
                                                                     item))),
            new Task(() => FinishedRenderingJpegHd?.Invoke(Convert(webRootPath,
                                                                   id,
                                                                   originalFilePath,
                                                                   sourceFormat,
                                                                   "JPEG",
                                                                   ...
                                                                   scan,
                                                                   item))),
            new Task(() => FinishedRenderingJp2k4kThumbnail?.Invoke(Convert(webRootPath,
                                                                            id,
                                                                            originalFilePath,
                                                                            sourceFormat,
                                                                            "JP2K",
                                                                            ...
                                                                            scan,
                                                                            item))),
            new Task(() => FinishedRenderingJp2k1440Thumbnail?.Invoke(Convert(webRootPath,
                                                                              id,
                                                                              originalFilePath,
                                                                              sourceFormat,
                                                                              "JP2K",
                                                                              ...
                                                                              scan,
                                                                              item))),
            new Task(() => FinishedRenderingJp2kHdThumbnail?.Invoke(Convert(webRootPath,
                                                                            id,
                                                                            originalFilePath,
                                                                            sourceFormat,
                                                                            "JP2K",
                                                                            ...
                                                                            scan,
                                                                            item))),
            new Task(() => FinishedRenderingJp2k4k?.Invoke(Convert(webRootPath,
                                                                   id,
                                                                   originalFilePath,
                                                                   sourceFormat,
                                                                   "JP2K",
                                                                   ...
                                                                   scan,
                                                                   item))),
            new Task(() => FinishedRenderingJp2k1440?.Invoke(Convert(webRootPath,
                                                                     id,
                                                                     originalFilePath,
                                                                     sourceFormat,
                                                                     "JP2K",
                                                                     ...
                                                                     scan,
                                                                     item))),
            new Task(() => FinishedRenderingJp2kHd?.Invoke(Convert(webRootPath,
                                                                   id,
                                                                   originalFilePath,
                                                                   sourceFormat,
                                                                   "JP2K",
                                                                   ...
                                                                   scan,
                                                                   item))),
            new Task(() => FinishedRenderingWebp4kThumbnail?.Invoke(Convert(webRootPath,
                                                                            id,
                                                                            originalFilePath,
                                                                            sourceFormat,
                                                                            "WEBP",
                                                                            ...
                                                                            scan,
                                                                            item))),
            new Task(() => FinishedRenderingWebp1440Thumbnail?.Invoke(Convert(webRootPath,
                                                                              id,
                                                                              originalFilePath,
                                                                              sourceFormat,
                                                                              "WEBP",
                                                                              ...
                                                                              scan,
                                                                              item))),
            new Task(() => FinishedRenderingWebpHdThumbnail?.Invoke(Convert(webRootPath,
                                                                            id,
                                                                            originalFilePath,
                                                                            sourceFormat,
                                                                            "WEBP",
                                                                            ...
                                                                            scan,
                                                                            item))),
            new Task(() => FinishedRenderingWebp4k?.Invoke(Convert(webRootPath,
                                                                   id,
                                                                   originalFilePath,
                                                                   sourceFormat,
                                                                   "WEBP",
                                                                   ...
                                                                   scan,
                                                                   item))),
            new Task(() => FinishedRenderingWebp1440?.Invoke(Convert(webRootPath,
                                                                     id,
                                                                     originalFilePath,
                                                                     sourceFormat,
                                                                     "WEBP",
                                                                     ...
                                                                     scan,
                                                                     item))),
            new Task(() => FinishedRenderingWebpHd?.Invoke(Convert(webRootPath,
                                                                   id,
                                                                   originalFilePath,
                                                                   sourceFormat,
                                                                   "WEBP",
                                                                   ...
                                                                   scan,
                                                                   item))),
            new Task(() => FinishedRenderingHeif4kThumbnail?.Invoke(Convert(webRootPath,
                                                                            id,
                                                                            originalFilePath,
                                                                            sourceFormat,
                                                                            "HEIF",
                                                                            ...
                                                                            scan,
                                                                            item))),
            new Task(() => FinishedRenderingHeif1440Thumbnail?.Invoke(Convert(webRootPath,
                                                                              id,
                                                                              originalFilePath,
                                                                              sourceFormat,
                                                                              "HEIF",
                                                                              ...
                                                                              scan,
                                                                              item))),
            new Task(() => FinishedRenderingHeifHdThumbnail?.Invoke(Convert(webRootPath,
                                                                            id,
                                                                            originalFilePath,
                                                                            sourceFormat,
                                                                            "HEIF",
                                                                            ...
                                                                            scan,
                                                                            item))),
            new Task(() => FinishedRenderingHeif4K?.Invoke(Convert(webRootPath,
                                                                   id,
                                                                   originalFilePath,
                                                                   sourceFormat,
                                                                   "HEIF",
                                                                   ...
                                                                   scan,
                                                                   item))),
            new Task(() => FinishedRenderingHeif1440?.Invoke(Convert(webRootPath,
                                                                     id,
                                                                     originalFilePath,
                                                                     sourceFormat,
                                                                     "HEIF",
                                                                     ...
                                                                     scan,
                                                                     item))),
            new Task(() => FinishedRenderingHeifHd?.Invoke(Convert(webRootPath,
                                                                   id,
                                                                   originalFilePath,
                                                                   sourceFormat,
                                                                   "HEIF",
                                                                   ...
                                                                   scan,
                                                                   item))),
            new Task(() => FinishedRenderingAvif4kThumbnail?.Invoke(Convert(webRootPath,
                                                                            id,
                                                                            originalFilePath,
                                                                            sourceFormat,
                                                                            "AVIF",
                                                                            ...
                                                                            scan,
                                                                            item))),
            new Task(() => FinishedRenderingAvif1440Thumbnail?.Invoke(Convert(webRootPath,
                                                                              id,
                                                                              originalFilePath,
                                                                              sourceFormat,
                                                                              "AVIF",
                                                                              ...
                                                                              scan,
                                                                              item))),
            new Task(() => FinishedRenderingAvifHdThumbnail?.Invoke(Convert(webRootPath,
                                                                            id,
                                                                            originalFilePath,
                                                                            sourceFormat,
                                                                            "AVIF",
                                                                            ...
                                                                            scan,
                                                                            item))),
            new Task(() => FinishedRenderingAvif4K?.Invoke(Convert(webRootPath,
                                                                   id,
                                                                   originalFilePath,
                                                                   sourceFormat,
                                                                   "AVIF",
                                                                   ...
                                                                   scan,
                                                                   item))),
            new Task(() => FinishedRenderingAvif1440?.Invoke(Convert(webRootPath,
                                                                     id,
                                                                     originalFilePath,
                                                                     sourceFormat,
                                                                     "AVIF",
                                                                     ...
                                                                     scan,
                                                                     item))),
            new Task(() => FinishedRenderingAvifHd?.Invoke(Convert(webRootPath,
                                                                   id,
                                                                   originalFilePath,
                                                                   sourceFormat,
                                                                   "AVIF",
