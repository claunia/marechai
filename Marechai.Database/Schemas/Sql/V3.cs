...
public static class V3
{
    ...
    public static readonly string MarechaiDb = """
                                               CREATE TABLE `marechai_db` (
                                                                                               `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    public static readonly string DiskFormats = """
                                                CREATE TABLE IF NOT EXISTS `disk_formats` (
                                                                                                     `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    public static readonly string MusicSynths = """
                                                CREATE TABLE IF NOT EXISTS `music_synths` (
                                                                                                     `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    public static readonly string OwnedComputers = """
                                                   CREATE TABLE IF NOT EXISTS `owned_computers` (
                                                                                                           `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    public static readonly string OwnedConsoles = """
                                                  CREATE TABLE IF NOT EXISTS `owned_consoles` (
                                                                                                         `id` int(11) NOT NULL AUTO_INCREMENT,
                                                                                                         `db_id` int(11) NOT NULL DEFAULT '0',
                                                                                                         `date` char(20) NOT NULL DEFAULT '',
                                                                                                         `status` int(11) NOT NULL DEFAULT '0',
    ...
    public static readonly string SoundSynths = """
                                                CREATE TABLE IF NOT EXISTS `sound_synths` (
                                                                                                     `id` int(11) NOT NULL AUTO_INCREMENT,
                                                                                                     `name` char(50) NOT NULL DEFAULT '',
                                                                                                      PRIMARY KEY (`id`)
                                                                                                      );
