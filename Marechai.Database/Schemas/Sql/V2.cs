...
public static class V2
{
    ...
    public static readonly string BrowserTests = """
                                                 CREATE TABLE IF NOT EXISTS `browser_test` (
    ...
    public static readonly string ConsoleCompanies = """
                                                     CREATE TABLE IF NOT EXISTS `console_company` (
    ...
    public static readonly string Cpus = """
    ...
    public static readonly string Dsps = """
    ...
    public static readonly string DiskFormats = """
                                                CREATE TABLE IF NOT EXISTS `Formatos_de_disco` (
                                                                                                     `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    public static readonly string Mpus = """
    ...
    public static readonly string OwnComputers = """
                                                 CREATE TABLE IF NOT EXISTS `own_computer` (
                                                                                                       `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    public static readonly string OwnConsoles = """
                                                CREATE TABLE IF NOT EXISTS `own_consoles` (
                                                                                                     `id` int(11) NOT NULL AUTO_INCREMENT,
                                                                                                     `db_id` int(11) NOT NULL DEFAULT '0',
                                                                                                     `date` char(20) NOT NULL DEFAULT '',
                                                                                                     `status` int(11) NOT NULL DEFAULT '0',
