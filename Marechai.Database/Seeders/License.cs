    ...
    public static class License
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Models.License>()
                        .HasData(new {Id = 1, Name = "Fair use", FsfApproved            = false, OsiApproved = false},
                                 new {Id = 2, Name = "Advertisement use", FsfApproved   = false, OsiApproved = false},
                                 new {Id = 3, Name = "All rights reserved", FsfApproved = false, OsiApproved = false},
                                 new
                                 {
                                     Id          = 4,
