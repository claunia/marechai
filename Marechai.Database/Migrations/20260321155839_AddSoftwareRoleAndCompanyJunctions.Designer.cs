...
namespace Marechai.Database.Migrations
{
    ...
    [Migration("20260321155839_AddSoftwareRoleAndCompanyJunctions")]
    partial class AddSoftwareRoleAndCompanyJunctions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Marechai.Database.Models.BookScan", b =>
                {
                    ...
                    b.Property<string>("ScannerManufacturer")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Marechai.Database.Models.Company", b =>
                {
                    ...
                    b.Property<bool>("FoundedDayIsUnknown")
                        .HasColumnType("bit(1)");

                    b.Property<bool>("FoundedMonthIsUnknown")
                        .HasColumnType("bit(1)");
                    ...
                    b.Property<bool>("SoldDayIsUnknown")
                        .HasColumnType("bit(1)");

                    b.Property<bool>("SoldMonthIsUnknown")
                        .HasColumnType("bit(1)");
            ...
            modelBuilder.Entity("Marechai.Database.Models.SoftwareRelease", b =>
                {
                    ...
                    b.HasIndex("SoftwareVersionId", "RegionId", "PlatformId");
            ...
            modelBuilder.Entity("Marechai.Database.Models.SoftwareSubvariant", b =>
                {
                    ...
                    b.ToTable("SoftwareSubvariants");
                });

            modelBuilder.Entity("Marechai.Database.Models.SoftwareSubvariantLanguage", b =>
                {
                    b.Property<ulong>("SubvariantId")
                        .HasColumnType("bigint unsigned");
                    ...
                    b.HasKey("SubvariantId", "LanguageCode");

                    b.HasIndex("LanguageId");

                    b.ToTable("SoftwareSubvariantLanguages");
                });
            ...
            modelBuilder.Entity("Marechai.Database.Models.SoftwareVariant", b =>
                {
                    ...
                    b.HasIndex("SoftwareId", "Name")
                        .IsUnique();

                    b.ToTable("SoftwareVariants");
                });

            modelBuilder.Entity("Marechai.Database.Models.SoftwareVariantLanguage", b =>
                {
                    b.Property<ulong>("VariantId")
                        .HasColumnType("bigint unsigned");
                    ...
                    b.HasKey("VariantId", "LanguageCode");

                    b.HasIndex("LanguageId");

                    b.ToTable("SoftwareVariantLanguages");
                });
            ...
            modelBuilder.Entity("Marechai.Database.Models.SoftwareRelease", b =>
                {
                    ...
                    b.HasOne("Marechai.Database.Models.Iso31661Numeric", "Region")
                        .WithMany("SoftwareReleases")
                    ...
                    b.HasOne("Marechai.Database.Models.SoftwareVariant", "Variant")
                        .WithMany()
            ...
            modelBuilder.Entity("Marechai.Database.Models.SoftwareVariant", b =>
                {
                    ...
                    b.HasOne("Marechai.Database.Models.SoftwareVersion", null)
                        .WithMany("Variants")
                        .HasForeignKey("SoftwareVersionId");
