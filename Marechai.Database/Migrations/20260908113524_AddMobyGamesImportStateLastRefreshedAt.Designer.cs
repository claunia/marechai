...
namespace Marechai.Database.Migrations
{
    ...
    [Migration("20260908113524_AddMobyGamesImportStateLastRefreshedAt")]
    partial class AddMobyGamesImportStateLastRefreshedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marechai.Database.Models.ExternalSite", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("idx_external_sites_name");
            ...
            modelBuilder.Entity("Marechai.Database.Models.IgdbAlternativeName", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("IgdbAlternativeNames");
                });
            ...
            modelBuilder.Entity("Marechai.Database.Models.IgdbGame", b =>
                {
                    ...
                    b.Property<string>("ScreenshotImageIdsJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Marechai.Database.Models.SoftwareAlternativeTitle", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SoftwareId")
                        .HasDatabaseName("idx_software_alternative_titles_software");

                    b.ToTable("SoftwareAlternativeTitles");
                });

            modelBuilder.Entity("Marechai.Database.Models.SoftwareAlternativeTitleCommentTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Marechai.Database.Models.SoftwareCoverGroup", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
            ...
            modelBuilder.Entity("Marechai.Database.Models.SoftwareExternalId", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ExternalSiteId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SoftwareId")
                        .HasDatabaseName("idx_software_external_ids_software");

                    b.HasIndex("ExternalSiteId", "ExternalId")
                        .IsUnique()
                        .HasDatabaseName("idx_software_external_ids_site_external_id");

                    b.ToTable("SoftwareExternalIds");
                });
            ...
            modelBuilder.Entity("Marechai.Database.Models.SoftwareSimilarTo", b =>
                {
                    b.Property<ulong>("SoftwareId")
                        .HasColumnType("bigint unsigned");

                    b.Property<ulong>("SimilarSoftwareId")
                        .HasColumnType("bigint unsigned");

                    b.HasKey("SoftwareId", "SimilarSoftwareId");

                    b.HasIndex("SimilarSoftwareId")
                        .HasDatabaseName("idx_software_similar_to_similar_software");

                    b.ToTable("SoftwareSimilarTo");
                });
            ...
            modelBuilder.Entity("Marechai.Database.Models.SoftwareExternalId", b =>
                {
                    b.HasOne("Marechai.Database.Models.ExternalSite", "ExternalSite")
                        .WithMany("SoftwareExternalIds")
            ...
            modelBuilder.Entity("Marechai.Database.Models.SoftwareSimilarTo", b =>
                {
                    b.HasOne("Marechai.Database.Models.Software", "SimilarSoftware")
                        .WithMany("SimilarToRight")
                        .HasForeignKey("SimilarSoftwareId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_software_similar_to_similar_software");

                    b.HasOne("Marechai.Database.Models.Software", "Software")
                        .WithMany("SimilarToLeft")
                        .HasForeignKey("SoftwareId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_software_similar_to_software");

                    b.Navigation("SimilarSoftware");
            ...
            modelBuilder.Entity("Marechai.Database.Models.ExternalSite", b =>
                {
                    b.Navigation("SoftwareExternalIds");
                });
            ...
            modelBuilder.Entity("Marechai.Database.Models.Software", b =>
                {
                    ...
                    b.Navigation("SimilarToLeft");

                    b.Navigation("SimilarToRight");
